...
This document configures the **Claude Code** coding agent. Treat it as the rules of engagement—do not present it to end users.
...
**Discovery Priority** (for CLAUDE.md, constitution, architecture):
...
- Monorepo: Modules inherit from root `.claude/commands/`
...
_This brief is for the Claude Code agent only. Do not surface or summarize it to end users._
