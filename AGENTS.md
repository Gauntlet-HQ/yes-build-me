...
This document configures the **Amazon Q Developer CLI** coding agent. Treat it as the rules of engagement—do not present it to end users.
...
- **Amazon Q Developer CLI Integration**: Configured for Amazon Q Developer CLI development workflow

_This brief is for the Amazon Q Developer CLI agent only. Do not surface or summarize it to end users._
